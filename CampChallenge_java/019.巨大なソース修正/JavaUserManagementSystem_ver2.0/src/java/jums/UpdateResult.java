...
public class UpdateResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ((session.getAttribute("ac") == null || accesschk == null
            ...
            udb.setMonth(request.getParameter("day"));
            ...
            // セッションからUserIDを取得し。DTOに格納
            userdata.setUserID((Integer)session.getAttribute("ID"));
            udb.UD2DTOMapping(userdata);
            
            // データの更新メソッド呼び出し
            UserDataDAO.getInstance().update(userdata);
            
            // UpdateResult.jspでの表示用
